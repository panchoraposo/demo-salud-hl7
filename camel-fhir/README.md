# FHIR Server
```shell script
podman run -d -p 8080:8080 hapiproject/hapi:latest
```

Swagger: http://localhost:8080/fhir
...
You can then execute your native executable with: `./target/camel-fhir-1.0.0-SNAPSHOT-runner`
